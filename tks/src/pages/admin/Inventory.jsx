...
const [error, setError] = useState(null);
  ...
  const fetchInventory = async () => {
    const res = await axios.get('https://tks-backend-2g8f.onrender.com/api/inventory');
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (editingItem) {
      await axios.put(`https://tks-backend-2g8f.onrender.com/api/inventory/${editingItem._id}`, formData);
    } else {
      await axios.post('https://tks-backend-2g8f.onrender.com/api/inventory', formData);
    }
    fetchInventory();
    resetForm();
  };
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Are you sure you want to delete this item?")) {
      await axios.delete(`https://tks-backend-2g8f.onrender.com/api/inventory/${id}`);
      fetchInventory();
    }
  };
