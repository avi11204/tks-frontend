...
const Clients = () => {
  ...
  const fetchClients = async () => {
    const res = await axios.get('https://tks-backend-2g8f.onrender.com/api/clients');
    setClients(res.data);
  };
  ...
  const handleSubmit = async e => {
    e.preventDefault();
    if (editingClient) {
      await axios.put(`https://tks-backend-2g8f.onrender.com/api/clients/${editingClient._id}`, formData);
    } else {
      await axios.post('https://tks-backend-2g8f.onrender.com/api/clients', formData);
    }
    fetchClients();
    resetForm();
  };
  ...
  const handleDelete = async id => {
    await axios.delete(`https://tks-backend-2g8f.onrender.com/api/clients/${id}`);
    fetchClients();
  };
