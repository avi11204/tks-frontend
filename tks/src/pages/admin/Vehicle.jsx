...
const Vehicles = () => {
  ...
  const fetchVehicles = async () => {
    const res = await axios.get('https://tks-backend-2g8f.onrender.com/api/vehicles');
  ...
  const handleSubmit = async e => {
    e.preventDefault();
    if (editingVehicle) {
      await axios.put(`https://tks-backend-2g8f.onrender.com/api/vehicles/${editingVehicle._id}`, formData);
    } else {
      await axios.post('https://tks-backend-2g8f.onrender.com/api/vehicles', formData);
    }
    fetchVehicles();
    resetForm();
  };
  ...
  const handleDelete = async id => {
    await axios.delete(`https://tks-backend-2g8f.onrender.com/api/vehicles/${id}`);
    fetchVehicles();
  };
