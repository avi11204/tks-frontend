...
const PlaceOrder = () => {
  ...
  const handleSubmit = async e => {
    ...
    const orderData = {
      ...
      // email, phone, preferredDeliveryDate, notes are frontend-only fields and not sent
    };

    try {
      await axios.post('https://tks-backend-auvd.onrender.com/api/orders', orderData);
